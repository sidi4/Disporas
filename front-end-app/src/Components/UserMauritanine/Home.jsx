        ...
        <div className="container">
            <div className="row">
                <div className="col-12 col-lg-5 pt-lg-50 px-50 px-lg-7">
                    <div className='dive1'>
                    <h1 className="bmb-3 mt-20 fs-38 d-flex flex-column flex-lg-row w-100 justify-content-center justify-content-lg-start align-items-center">
                    ...
                    <div className="row gap-20">
                        <div className=''>
                        <Link to={"/ajouter-Diaspora"}><Button className='Button1'>Inscrption dans le platform diaspora</Button></Link>
                        </div>    
                    </div>
                </div>
                </div>
